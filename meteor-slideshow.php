		...
		while ( $meteor_loop->have_posts() ) : $meteor_loop->the_post(); ?>
			...
			<div class="mslide mslide-<?php echo $meteor_count; ?>">
                ...
                <?php the_post_thumbnail( 'featured-slide', array( 'title' => get_the_title() ) ); ?>
                               ...
                               <div class="meteor-slide-heading">
              		<?php if( get_field( "slider_main_heading" ) ): ?>
    					 <div class="heading-large"><?php the_field('slider_main_heading'); ?></div>
     				<?php endif; ?>
                    
                    <?php if( get_field( "slider_main_heading" ) ): ?>
    					 <div class="heading-medium"><?php the_field('slider_main_heading'); ?></div>
     				<?php endif; ?>

                   <?php if( get_field('slider_buttons') ): ?>

					<?php while( has_sub_field("slider_buttons") ): ?>
                
                        <?php if(get_row_layout() == "single_button"): ?>
                
                            <button class="green-btn" href="<?php the_sub_field("single_button_link"); ?>">
                                <?php the_sub_field("single_button_copy"); ?>
                            </button>
                
                        <?php elseif(get_row_layout() == "two_buttons"):?>
                
                            <button class="green-btn" href="<?php the_sub_field("button_left_link"); ?>">
                                <?php the_sub_field("button_left_copy"); ?>
                            </button>
                            
                             <button class="green-btn" href="<?php the_sub_field("button_right_link"); ?>">
                                <?php the_sub_field("button_right_copy"); ?>
                            </button>
